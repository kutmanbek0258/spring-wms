...
export default defineComponent({
    ...
    methods: {
        ...mapActions('salesman', ['getAllSalesmen', 'createSalesman', 'updateSalesman', 'deleteSalesman']),
        ...
        editItem (item) {
            this.editedIndex = this.salesmen.indexOf(item)
        ...
        deleteItemConfirm () {
            this.deleteSalesman({id: this.editedItem.id})
            this.closeDelete()
        },
        ...
        <v-data-table-server
            ...
            <template v-slot:top>
                <v-toolbar
                    flat
                >
                    <v-toolbar-title>Salesmen</v-toolbar-title>
                    <v-divider
                        class="mx-4"
                        inset
                        vertical
