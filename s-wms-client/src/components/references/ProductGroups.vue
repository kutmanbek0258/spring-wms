...
export default defineComponent({
    ...
    methods: {
        ...mapActions('productGroup', ['getAllProductGroups', 'createProductGroup', 'updateProductGroup', 'deleteProductGroup']),
        ...
        deleteItemConfirm () {
            ...
            this.deleteProductGroup({id: this.editedItem.id})
            this.closeDelete()
        },
        ...
        <v-data-table-server
            ...
            <template v-slot:top>
                <v-toolbar
                    flat
                >
                    <v-toolbar-title>Product groups</v-toolbar-title>
                    <v-divider
                        class="mx-4"
                        inset
                        vertical
