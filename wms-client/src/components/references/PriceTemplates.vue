...
export default defineComponent({
    ...
    methods: {
        ...mapActions('priceTemplate', ['getAllPriceTemplates', 'createPriceTemplate', 'updatePriceTemplate', 'deletePriceTemplate']),
        ...
        editItem (item) {
            console.log(item.id);
            this.editedIndex = this.priceTemplates.indexOf(item)
        ...
        deleteItemConfirm () {
            ...
            this.deletePriceTemplate({id: this.editedItem.id})
            this.closeDelete()
        },
        ...
        <v-data-table-server
            ...
            <template v-slot:top>
                <v-toolbar
                    flat
                >
                    <v-toolbar-title>Price templates</v-toolbar-title>
                    <v-divider
                        class="mx-4"
                        inset
                        vertical
